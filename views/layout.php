    ...
    <div class="flex justify-center">
        <nav class="max-w-3xl w-full my-4 mx-2 flex justify-between ring-1 shadow ring-black/10 rounded-full py-2 px-4 bg-slate-50">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="https://github.com/BorisKlco/php.FileSharing" target="_blank" class="px-2 py-1 rounded-full bg-teal-500 ring-1 ring-black/10 text-slate-100 font-semibold text-sm hover:bg-teal-600 hover:text-white">
